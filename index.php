...
<div class="signup signup-body">
  <div id="container">
      ...
      <div id="content">
        <form name="frm_order" id="frm_order" action="" method="post">
          ...
          <div id="review_order">
            ...
            <div id="btn" class="right">
              <input type="submit" name="btn_submit" value="&laquo; Back" class="submit btn" onclick="$('#section').val(1);">
              &nbsp;
              <input type="submit" name="btn_submit" value="Complete Order &raquo;" class="submit">
            </div>
          </div>
          <?php        
                break;
    ...
    <div id="footer">
      ...
      <?php } ?>
      Copyright &copy; <?php echo($settings['company_name']);?> <?php echo(date("Y"));?>, All rights reserved. </div>
  </div>
</div>
<!-- closes signup-body -->
</body>
